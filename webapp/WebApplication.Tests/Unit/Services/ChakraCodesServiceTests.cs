...
namespace K9.WebApplication.Tests.Unit.Services
{
    ...
    {   
        [Theory]
        [InlineData(1979, 6, 16, EChakraCode.Warrior, EChakraCode.Manifestor, EChakraCode.Royal, EChakraCode.Mystic, EChakraCode.Healer, EChakraCode.Peacemaker, EChakraCode.Royal, EChakraCode.Healer)]
